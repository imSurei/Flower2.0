				...
				<div style="width: 60%; margin: 0 auto; padding:0">
					...
					<input type="hidden" name="id" value="${ requestScope.member.id }">
						...
						<div class="form-group">
							...
							<input type="text" name="account" id="account" class="form-control" value="${ requestScope.member.account }"required>
							...
							<input type="password" name="password" id="password" class="form-control" value="${ requestScope.member.password }" required>
						...
						<div class="form-group">
							...
							value="${ requestScope.member.name }"required>
						...
						<div class="form-group">
							<label for="birthDate">出生日期</label><br> <input type="Date"
								...
								value="${ requestScope.member.birthDate }"required>
						</div>
						...
						<div class="form-group">
							<label for="email">電子信箱</label> <input type="email" name="email"
								...
								value="${ requestScope.member.email }"required>
						...
						<div class="form-group">
							<label for="address">住址</label> <input type="text" name="address"
								...
								value="${ requestScope.member.address }"required>
						...
						<div class="form-group">
							<label for="phone">手機號碼</label> <input type="text" name="phone"
								...
								value="${ requestScope.member.phone }"required>
