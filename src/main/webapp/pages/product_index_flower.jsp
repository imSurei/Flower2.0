...
<head>
<meta charset="UTF-8">
<title>鮮花花束．Flower Forever</title>
<base href="<%=basePath %>">
<!-- Bootstrap -->
<link
...
<link href="css/product_index_flower.css" rel="stylesheet" />
			...
			console.log(json);
			 let ln = json.length;
        		...
        		for (i = 0; i < ln; i++) {           			
           		...
           		let title = '<div class="prods-content-title"><p>鮮花花束</p><div class="seg2"></div></div>';
