...
<body style="background-color: #f5f6fa">
   <div class="header"></div>
	...
	<div class="main">
		<h2>商品管理</h2>
		<hr>
		<h2 style="color: blue;">新增資料</h2>
		<!-- 隱藏向servlet提交請求 -->
		<form id="form-insert" action="<%=path %>:8080/MyFlower2.0/manager/ProductServlet"
...
<!--    ---------------------------------------------------------------------------------------  -->
			<div class="col-md-3 image">
				<p>圖片</p>
				<input type="file" name="imgPath" value="pics/productPics/index2.jpg"> <span
