...
<head>
<meta charset="UTF-8">
<title>商品首頁．Flower Forever</title>
<base href="<%=basePath %>">
<!-- Bootstrap -->
<link
			...
			<div class="prods-imgs">
				<div id="carouselExampleFade" class="carousel slide carousel-fade"
					...
					<div class="carousel-inner">
						...
						<a href="<%=path %>:8080/MyFlower2.0/manager/ProductServlet?action=getProduct2&id=1006">
							<img src="pics/productPics/index1.jpg" class="d-block w-100"
								alt="..."></a>
						</div>
						<div class="carousel-item">
						<a href="<%=path %>:8080/MyFlower2.0/manager/ProductServlet?action=getProduct2&id=1005">
							<img src="pics/productPics/index2.jpg" class="d-block w-100"
								alt="..."></a>
						</div>
						<div class="carousel-item">
						<a href="<%=path %>:8080/MyFlower2.0/manager/ProductServlet?action=getProduct2&id=1003">
