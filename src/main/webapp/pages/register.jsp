...
<script>
	function signOut() {
		<%-- window.location = <%=path %>+":8080/MyFlower2.0/pages/index.jsp"; --%>
	};
				...
				<div style="width: 60%; margin: 0 auto; padding:0">
					...
					<input type="hidden" name="action" value="register">
						...
						<div class="btnsuccess">
							<button style="width: 30%; height: 50px;" type="submit"
								class="btn btn-success" id="sub_btn">提交</button>
						</div>
					</form>
